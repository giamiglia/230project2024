...
(cor1test <- cor.test(data$invs_A, data$invs_B, conf.level = .95))
...
for(i in 1:n_samp){
  ...
  fakedata <-  data[s, ]
  corResults[i] <- cor(fakedata$invs_A, fakedata$invs_B)
}
...
hist(diff,
     main = "Permuted Sample Median Differences in BLANK",
     xlab = "Danceability",
     col = "aquamarine",
     breaks = 20)
