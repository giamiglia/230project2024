...
Using the quantile plot, we checked that the variables we are interested in are roughly normally distributed ...(analyse plot)... sems like they are so we will go ahead and run linear models on them
...
studres(bestmodel)
```
Mention that there are outliers.
